        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Capitaland Market Inspection Tool</span>
              <img
                alt=""
        ...
        <div className="mx-auto max-w-2xl py-24 sm:py-32 lg:py-40">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">
              Deal Scanner: AI-Powered Market Intelligence
            </h1>
            <p className="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Identify emerging and fast-growing industries, discover potential
              real estate needs, and stay ahead with real-time alerts powered by
              CapitaLand's AI Deal Scanner
            </p>
