...
class ExpansionEvalCompany(CompanyMetricRanking):
...
class ExpansionEvalCompanyList(BaseModel):
    companies: List[ExpansionEvalCompany] = Field(..., description="A list of signalled companies with their metrics and signals")
